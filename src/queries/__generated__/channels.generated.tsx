...
export type GetChannelsCountQuery = {
  __typename: 'Query';
 ...
 * });
 */
export function useGetChannelsCountQuery(
  baseOptions?: Apollo.QueryHookOptions<GetChannelsCountQuery, GetChannelsCountQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetChannelsCountQuery, GetChannelsCountQueryVariables>(GetChannelsCountDocument, options);
}
export function useGetChannelsCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetChannelsCountQuery, GetChannelsCountQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
