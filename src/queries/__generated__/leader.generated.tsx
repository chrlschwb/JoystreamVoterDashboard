...
export type LeaderFragment = {
  ...
  groupId: GroupIdName;
  workersHired: Array<LeaderNameFragment>;
  opening: { type: string };
};
...
export function useLeadersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetLeaderQuery, GetLeaderQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type PostOfLeaderFragment = {
  __typename: 'Leader';
  createdAt: any | undefined;
...
export function usePostOfLeadersQuery(
  baseOptions?: Apollo.QueryHookOptions<GetPostOfLeaderQuery, GetPostOfLeaderQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetPostOfLeaderQuery, GetPostOfLeaderQueryVariables>(GetPostOfLeaderDocument, options);
}
export function usePostOfLeadersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetPostOfLeaderQuery, GetPostOfLeaderQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type GetTerminatedWorkerQuery = {
  __typename: 'Query';
  terminatedWorkerEvents: Array<TerminatedWorkerFragment>;
};
...
export function useTerminatedQuery(
  baseOptions?: Apollo.QueryHookOptions<GetTerminatedWorkerQuery, GetTerminatedWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTerminatedWorkerQuery, GetTerminatedWorkerQueryVariables>(GetTerminatedDocument, options);
}
export function useTerminatedLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetTerminatedWorkerQuery, GetTerminatedWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetTerminatedWorkerQuery, GetTerminatedWorkerQueryVariables>(
    GetTerminatedDocument,
    options
  );
}
...
export type GetTerminatedWorkderQueryResult = Apollo.QueryResult<
  GetTerminatedWorkerQuery,
  GetTerminatedWorkerQueryVariables
>;
...
export type GetExitedWorkerQuery = {
  __typename: 'Query';
  workerExitedEvents: Array<ExitedWorkerFragment>;
};
...
export function useExitedQuery(
  baseOptions?: Apollo.QueryHookOptions<GetExitedWorkerQuery, GetExiteddWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetExitedWorkerQuery, GetExiteddWorkerQueryVariables>(GetExitedDocument, options);
}
export function useExitedLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetExitedWorkerQuery, GetExiteddWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type GetSlashedWorkerQuery = {
  __typename: 'Query';
  workEntrySlashedEvents: Array<SlashedWorkerFragment>;
};
...
export function useSlashedQuery(
  baseOptions?: Apollo.QueryHookOptions<GetSlashedWorkerQuery, GetSlasheddWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetSlashedWorkerQuery, GetSlasheddWorkerQueryVariables>(GetSlashedDocument, options);
}
export function useSlashedLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetSlashedWorkerQuery, GetSlasheddWorkerQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type TerminatedLeadagment = {
  __typename: 'TerminatedLeaderEventWhereInput';
  createdAt: any | undefined;
  groupId: string;
  worker: {
    membership: {
...
export function useTermiatedLeadQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTerminatedLeadQuery, GetTerminatedLeadQueryVariables>(GetSlashedDocument, options);
}
export function useTerminatedLeadLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetTerminatedLeadQuery, GetTerminatedLeadQueryVariables>(GetSlashedDocument, options);
}
